...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!localStorage.getItem('products')) {
    const defaultProducts = [
      { id: 1, title: "E-commerce Script", category: "script", price: 49, icon: "fa-shopping-cart", desc: "Script ពេញលេញសម្ាប់ហាងអនឡាញ", vendor: "DevMaster" },
      { id: 2, title: "WordPress SEO Plugin", category: "plugin", price: 29, icon: "fa-plug", desc: "Plugin សម្ាប់បង្កើន SEO", vendor: "PluginPro" },
      { id: 3, title: "Portfolio Template", category: "template", price: 19, icon: "fa-briefcase", desc: "Template ស្ាតសម្រាប់ Portfolio", vendor: "TemplateHub" },
      { id: 4, title: "Admin Dashboard UI", category: "ui", price: 39, icon: "fa-chart-line", desc: "UI Kit សម្ាប់ Admin Dashboard", vendor: "UIDesign" }
    ];
...
function renderProductsTable(products = null) {
  ...
  tbody.innerHTML = allProducts.map(p => `
    <tr>
      ...
      <td>
        <button class="btn-edit" onclick="openEditModal(${p.id})"><i class="fas fa-edit"></i></button>
